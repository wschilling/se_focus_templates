...
public class Board {
  ...
  private void performCastleKingSide( int kingPosition ) {
    ...
    this.squares[ kingPosition + 3 ] = this.squares[ kingPosition + 3 ];
   ...
   */
    ...
    if ( squareEmpty( position + 16 ) && squareEmpty( position + 32 ) ) {
  ...
  private boolean canCastleKingSide( int position ) {
    return ( true && !kingInCheck() && pieceTypeAt( position + 3 ) == ROOK && !hasPieceMoved( pieceAt( position + 3 ) )
